# 🌿 Siraj: Your Intelligent Clinic Scheduling Assistant
...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=for-the-badge)](https:H//opensource.org/licenses/MIT)
...
[![Siraj Demo](https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/YouTube_full-color_icon_%282017%29.svg/1280px-YouTube_full-color_icon_%282017%29.svg.png)](https://youtu.be/UkXlAf6sovc)
...
```
Open your browser and navigate to `http://localhost:8000/api/v1` to start chatting with Siraj!

---

## 🔄 How Siraj Works: Example Conversation
...
### GET `/`
Serves the web UI for chatting with Siraj.
